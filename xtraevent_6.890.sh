...
echo -e "${CYAN}"
echo "################################################################"
echo "#      Start downloading and installing  xtraevent_6.890       #"
echo "#####################################################$$$$$$$####"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/2410/refs/heads/main/enigma2-plugin-extensions-xtraevent_6.890_all.ipk"
IPK_NAME="enigma2-plugin-extensions-xtraevent_6.890_all.ipk"
